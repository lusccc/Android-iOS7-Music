...
public class SearchListViewPerformerAdapter extends SimpleCursorAdapter {
	...
	private ImageLoaderForPerformerSearchList mImageLoader;
	 ...
	 *            put content in Map
	 */
	public SearchListViewPerformerAdapter(Context context, int layout, Cursor c,
			String[] from, int[] to, int flags) {
		super(context, layout, c, from, to, flags);
		this.context = context;
		listContainer = LayoutInflater.from(context);
		mImageLoader = new ImageLoaderForPerformerSearchList(context);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String html = artist.replaceAll("(?u)"+containWords,"<b>"+containWords+"</b><br />");
		spanned = Html.fromHtml(html);
		viewHolder.musicArtist.setText(spanned); // 显示艺术家
