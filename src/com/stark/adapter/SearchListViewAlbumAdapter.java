...
import com.stark.util.ImageLoaderForAlbumSearchList;
import com.stark.util.ImageLoaderForPerformerSearchList;
import com.stark.util.ImageLoaderForSongSearchList;

public class SearchListViewAlbumAdapter extends SimpleCursorAdapter {
	...
	private ImageLoaderForAlbumSearchList mImageLoader;
	 ...
	 *            put content in Map
	 */
	public SearchListViewAlbumAdapter(Context context, int layout, Cursor c,
			String[] from, int[] to, int flags) {
		super(context, layout, c, from, to, flags);
		this.context = context;
		listContainer = LayoutInflater.from(context);
		mImageLoader = new ImageLoaderForAlbumSearchList(context);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String html = album.replaceAll("(?u)"+containWords,"<b>"+containWords+"</b><br />");
		spanned = Html.fromHtml(html);
		viewHolder.albumName.setText(spanned);// 显示专辑名
		viewHolder.musicArtist.setText(artist); // 显示艺术家
		viewHolder.musicTitle.setText(title);
