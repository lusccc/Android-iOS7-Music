...
public class ImageLoaderForSongsList {
	...
	public ImageLoaderForSongsList(Context mContext) {
		context = mContext;
	}
	...
	public void loadImage(long albumId, long songId,
			SongListViewAdapter adapter, ViewHolder holder, int position) {
	...
	class ImageLoadTask extends AsyncTask<Object, Void, Bitmap> {
		...
		private long albumId;
		private long songId;
		private SongListViewAdapter slvAdapter;
		...
		protected Bitmap doInBackground(Object... params) {
			...
			slvAdapter = (SongListViewAdapter) o;
