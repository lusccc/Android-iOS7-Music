...
public class ImageLoaderForAlbumSearchList {
	...
	public ImageLoaderForAlbumSearchList(Context mContext) {
		context = mContext;
	}
	...
	public void loadImage(long albumId, long songId,
			SearchListViewAlbumAdapter adapter, ViewHolder holder, int position) {
	...
	class ImageLoadTask extends AsyncTask<Object, Void, Bitmap> {
		...
		private long albumId;
		private long songId;
		private SearchListViewAlbumAdapter slvAdapter;
		...
		protected Bitmap doInBackground(Object... params) {
			...
			slvAdapter = (SearchListViewAlbumAdapter) o;
