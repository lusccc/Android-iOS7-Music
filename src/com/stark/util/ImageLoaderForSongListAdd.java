...
public class ImageLoaderForSongListAdd {
	...
	public ImageLoaderForSongListAdd(Context mContext) {
		context = mContext;
	}
	...
	public void loadImage(long albumId, long songId,
			SongListViewAdapterForAddActivity adapter, ViewHolder holder, int position) {
	...
	class ImageLoadTask extends AsyncTask<Object, Void, Bitmap> {
		...
		private long albumId;
		private long songId;
		private SongListViewAdapterForAddActivity slvAdapter;
		...
		protected Bitmap doInBackground(Object... params) {
			...
			slvAdapter = (SongListViewAdapterForAddActivity) o;
