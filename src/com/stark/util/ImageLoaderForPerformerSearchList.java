...
public class ImageLoaderForPerformerSearchList {
	...
	public ImageLoaderForPerformerSearchList(Context mContext) {
		context = mContext;
	}
	...
	public void loadImage(long albumId, long songId,
			SearchListViewPerformerAdapter adapter, ViewHolder holder, int position) {
	...
	class ImageLoadTask extends AsyncTask<Object, Void, Bitmap> {
		...
		private long albumId;
		private long songId;
		private SearchListViewPerformerAdapter slvAdapter;
		...
		protected Bitmap doInBackground(Object... params) {
			...
			slvAdapter = (SearchListViewPerformerAdapter) o;
