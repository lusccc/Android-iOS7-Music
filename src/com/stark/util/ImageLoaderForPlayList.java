...
public class ImageLoaderForPlayList {
	...
	public ImageLoaderForPlayList(Context mContext) {
		context = mContext;
	}
	...
	public void loadImage(long albumId, long songId,
			PlayListViewAdapter adapter, ViewHolder holder, int position) {
	...
	class ImageLoadTask extends AsyncTask<Object, Void, Bitmap> {
		...
		private long albumId;
		private long songId;
		private PlayListViewAdapter abmAdapter;
		...
		protected Bitmap doInBackground(Object... params) {
			...
			abmAdapter = (PlayListViewAdapter) o;
